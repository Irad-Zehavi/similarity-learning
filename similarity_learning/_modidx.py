  ...
  'syms': { 'similarity_learning.all': {},
            'similarity_learning.facenet': { 'similarity_learning.facenet.FaceNetInceptionResnetV1': ( 'facenet.html#facenetinceptionresnetv1',
                                             ...
                                             'similarity_learning.facenet.facenet': ( 'facenet.html#facenet',
                                                                                      'similarity_learning/facenet.py')},
            'similarity_learning.feature_space_plotting': { 'similarity_learning.feature_space_plotting.FeatureSpaceFigure': ( 'feature_space_plotting.html#featurespacefigure',
                                                                                                                               'similarity_learning/feature_space_plotting.py'),
                                                            'similarity_learning.feature_space_plotting.FeatureSpaceFigure.__init__': ( 'feature_space_plotting.html#featurespacefigure.__init__',
                                                                                                                                        'similarity_learning/feature_space_plotting.py'),
                                                            'similarity_learning.feature_space_plotting.FeatureSpaceFigure._plot_cluster': ( 'feature_space_plotting.html#featurespacefigure._plot_cluster',
                                                                                                                                             'similarity_learning/feature_space_plotting.py'),
                                                            'similarity_learning.feature_space_plotting.FeatureSpaceFigure.plot_dataset_embedding': ( 'feature_space_plotting.html#featurespacefigure.plot_dataset_embedding',
                                                                                                                                                      'similarity_learning/feature_space_plotting.py'),
                                                            'similarity_learning.feature_space_plotting.FeatureSpaceFigure.plot_sphere': ( 'feature_space_plotting.html#featurespacefigure.plot_sphere',
                                                                                                                                           'similarity_learning/feature_space_plotting.py')},
